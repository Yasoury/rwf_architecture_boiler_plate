...
class ComponentLibraryLocalizationsAr extends ComponentLibraryLocalizations {
  ...
  @override
  String get exceptionIndicatorGenericMessage => 'حدث خطأ.\nيرجى التحقق من اتصالك بالإنترنت والمحاولة مرة أخرى لاحقًا.';

  @override
  String get genericErrorSnackbarMessage => 'حدث خطأ. يرجى التحقق من اتصالك بالإنترنت.';

  @override
  String get authenticationRequiredErrorSnackbarMessage => 'تحتاج إلى تسجيل الدخول قبل القيام بهذا الإجراء.';
}
