...
class UserRepository {
  ...
  final BehaviorSubject<Profile?> _userSubject = BehaviorSubject();
  ...
  Future<void> signUp(
    ...
    try {
      ...
      if (error is UsernameAlreadyTakenFirebaseException) {
  ...
  Future<void> updateProfile(
    ...
    } on UsernameAlreadyTakenFirebaseException catch (_) {
      throw UsernameAlreadyTakenException();
    }
  }
